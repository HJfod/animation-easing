...
function ExponentalIn(frame, start, duration, startpos, amount, factor = 2) {
    /**
     * @name ExponentalIn
     * @author HJfod
     * @param frame The current frame
...
function ExponentalOut(frame, start, duration, startpos, amount, factor = 2) {
    /**
     * @name ExponentalOut
     * @author HJfod
     * @param frame The current frame
...
function Exponental(frame, start, duration, startpos, amount, factor = 3) {
    /**
     * @name Exponental
     * @author HJfod
     * @param frame The current frame
